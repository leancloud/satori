...
(def blackbox-cross-test-rules
  (sdo
    (where (host "host-of-cn-n1" "host-of-cn-e1" "host-of-us-w1")
      (plugin "url.check" 30 {:name "blackbox-api@cn-n1", :url "https://api.leancloud.cn/1.1/ping"})
      (plugin "url.check" 30 {:name "blackbox-api@cn-e1", :url "https://e1-api.leancloud.cn/1.1/ping"})
      (plugin "url.check" 30 {:name "blackbox-api@us-w1", :url "https://us-api.leancloud.cn/1.1/ping"})

      #_(plugin "url.check" 30 {:name "blackbox-engine@cn-n1", :url ""})
      #_(plugin "url.check" 30 {:name "blackbox-engine@cn-e1", :url ""})
      #_(plugin "url.check" 30 {:name "blackbox-engine@us-w1", :url ""})
